...
final class OrderOptionsView: View {
    ...
    var currentViewModel: OrderOptions.CurrentValuesViewModel = .init(
        ...
        didSet {
            ...
            cookTime.cookTime = currentViewModel.time.cookTime
            if currentViewModel.time.allowAnimation {
                cookTime.switchWithAnimation(currentViewModel.time.cookTimeEnabled)
            }
            else {
                cookTime.cookSwitch = currentViewModel.time.cookTimeEnabled
            }
        }
    }
